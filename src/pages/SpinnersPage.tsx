  ...
  return (
    <div className="w-full min-h-0">
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-content-primary mb-2">Spinners</h1>
        ...
        <div className="bg-surface-raised rounded-lg shadow-sm border border-stroke-subtle p-8 mb-8">
          ...
          <div className="space-y-12">
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Spinner Sizes</h3>
              <div className="flex items-end gap-8">
                ...
                <div className="flex flex-col items-center gap-3">
                  <Spinner size="xl" />
                  <span className="text-sm text-content-secondary">Extra Large</span>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Spinner Colors</h3>
              <div className="flex flex-wrap gap-8">
                ...
                <div className="flex flex-col items-center gap-3">
                  <Spinner color="info" />
                  <span className="text-sm text-content-secondary">Info</span>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Inline Spinners</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Overlay Spinner</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">In Context Examples</h3>
              <div className="space-y-6">
                <div className="border border-stroke-subtle rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-content-primary">Button Loading State</h4>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <button className="px-6 py-3 bg-surface-overlay text-content-tertiary rounded-lg cursor-not-allowed font-medium flex items-center gap-3">
                ...
                <div className="border border-stroke-subtle rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-content-primary">Card Loading State</h4>
                  </div>
                  <div className="bg-surface-sunken rounded-lg p-12 flex flex-col items-center justify-center gap-4">
                    <Spinner size="lg" />
                    <p className="text-content-secondary">Loading content...</p>
                  </div>
                </div>

                <div className="border border-stroke-subtle rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-content-primary">Table Loading State</h4>
                  </div>
                        ...
                        <tr>
                          <td colSpan={3} className="px-6 py-12">
                            <div className="flex flex-col items-center justify-center gap-3">
                              <Spinner />
                              <p className="text-content-secondary text-sm">Loading data...</p>
                            </div>
                          </td>
                        </tr>
                      </tbody>

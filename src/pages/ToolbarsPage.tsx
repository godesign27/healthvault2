  ...
  return (
    <div className="w-full min-h-0">
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-content-primary mb-2">Toolbars</h1>
        ...
        <div className="hv-surface-card p-8 mb-8">
          ...
          <div className="space-y-12">
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Horizontal Toolbars - Light</h3>
              <div className="space-y-8">
                <div>
                  <p className="text-sm text-content-secondary mb-4">Default with Right Label</p>
                  <Toolbar actions={defaultToolbarActions} variant="light" showLabels={true} />
                </div>

                <div>
                  <p className="text-sm text-content-secondary mb-4">Label Below Icons</p>
                  <Toolbar actions={defaultToolbarActions} variant="light" showLabels={true} />
                </div>

                <div>
                  <p className="text-sm text-content-secondary mb-4">Icons Only</p>
                  <Toolbar actions={iconOnlyActions} variant="light" showLabels={false} />
                </div>

                <div>
                  <p className="text-sm text-content-secondary mb-4">Default with Chart</p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Horizontal Toolbars - Dark</h3>
              <div className="space-y-8">
                <div>
                  <p className="text-sm text-content-secondary mb-4">Default with Right Label</p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Vertical Toolbars</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  <p className="text-sm text-content-secondary mb-4">Light - Icons Only</p>
                  <Toolbar
                ...
                <div>
                  <p className="text-sm text-content-secondary mb-4">Dark - Icons Only</p>
                  <Toolbar
                    actions={iconOnlyActions}
                    orientation="vertical"
                    variant="dark"
                ...
                <div>
                  <p className="text-sm text-content-secondary mb-4">Light - With Labels</p>
                  <Toolbar
                ...
                <div>
                  <p className="text-sm text-content-secondary mb-4">Dark - With Labels</p>
                  <Toolbar
                    actions={defaultToolbarActions}
                    orientation="vertical"
                    variant="dark"
            ...
            <div>
              <h3 className="text-lg font-semibold text-content-primary mb-4">Icon Link States</h3>
              <div className="space-y-6">
                <div className="grid grid-cols-6 gap-4">
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Default</p>
                    <button className="w-12 h-12 flex items-center justify-center border border-stroke-default rounded hover:bg-surface-sunken">
                      <Home className="w-5 h-5 text-content-secondary" />
                    </button>
                  </div>

                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Hover</p>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Selected</p>
                    <button className="w-12 h-12 flex items-center justify-center bg-[indigo-600] rounded">
                      <Home className="w-5 h-5 text-white" />
                    </button>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Pressed</p>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Disabled</p>
                    <button className="w-12 h-12 flex items-center justify-center border border-stroke-subtle rounded cursor-not-allowed" disabled>
                      <Home className="w-5 h-5 text-content-tertiary" />
                    </button>
                  </div>

                  <div className="flex flex-col items-center gap-2">
                    <p className="text-xs text-content-secondary uppercase">Focused</p>
                ...
                <div className="grid grid-cols-6 gap-4">
                  <div className="flex flex-col items-center gap-2">
                    <button className="px-4 py-2 flex items-center gap-2 border border-stroke-default rounded hover:bg-surface-sunken">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <button className="px-4 py-2 flex items-center gap-2 border border-stroke-subtle text-content-tertiary rounded cursor-not-allowed" disabled>
                      <Home className="w-5 h-5" />
                      <span className="text-sm">Name</span>
                    </button>
                  </div>

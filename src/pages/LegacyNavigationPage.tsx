  ...
  return (
    <div className="flex-1 overflow-auto bg-gray-50">
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Navigation - Legacy</h1>
        ...
        <div className="space-y-8">
          <section className="bg-white rounded-lg shadow-sm p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Navigation Links: Interactive States</h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-6">
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-3">Default</div>
                  <div className="w-20 h-20 flex items-center justify-center bg-white border border-gray-200">
          ...
          <section className="bg-white rounded-lg shadow-sm p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Drawer: Interactive States</h2>

            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Dark Drawer</h3>
              <div className="grid grid-cols-4 gap-6">
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-3">Default</div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Light Drawer (Mixed Mode)</h3>
              <div className="grid grid-cols-4 gap-6">
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-3">Default</div>
                  <div className="w-48 bg-white border border-gray-200 p-4">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-3">Hover</div>
                  <div className="w-48 bg-gray-50 border border-gray-200 p-4">
                    <span className="text-[14px] text-[#454250]">SUBMENU ITEM 1</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-3">Active</div>
                  <div className="w-48 bg-[#E7E6E8] border border-gray-200 p-4">
          ...
          <section className="bg-white rounded-lg shadow-sm p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Full Navigation Examples</h2>

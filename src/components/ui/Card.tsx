...
const stateClasses: Record<CardState, string> = {
  default:          '[background:var(--hv-component-card-background-default)] [border-color:var(--hv-component-card-border-default)]',
  hover:            '[background:var(--hv-component-card-background-default)] [border-color:var(--hv-component-card-border-hover)]',
...
export function Card({
  ...
  return (
    <div
      className={cn(
        'border transition-all rounded-hv-card',
        stateClasses[state],

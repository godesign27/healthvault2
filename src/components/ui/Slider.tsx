...
export function Slider({
  ...
  const fillColor = error
    ? 'var(--hv-color-action-destructive-default)'
    : disabled
      ? 'var(--hv-color-neutral-400)'
      : 'var(--hv-color-action-primary-default)';
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-surface-raised',
            '[&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:shadow-md',
            '[&::-webkit-slider-thumb]:transition-transform',
            error
              ? '[&::-webkit-slider-thumb]:border-action-destructive'
              : disabled
                ? '[&::-webkit-slider-thumb]:border-stroke-subtle'
                : '[&::-webkit-slider-thumb]:border-action-primary hover:[&::-webkit-slider-thumb]:scale-110',
            '[&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5',
            '[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-surface-raised',
            '[&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-action-primary',
          )}
